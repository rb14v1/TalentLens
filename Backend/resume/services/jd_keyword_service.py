...
# ✅ NEW: Stopwords to filter out non-technical terms
NON_SKILL_STOPWORDS = {
...
Technical Skills:"""
        ...
        for skill in raw_skills:
            ...
            # ✅ NEW: Skip empty strings after cleaning
            if not skill_clean:
                continue
           
            # ✅ NEW: Filter out stopwords
            if skill_clean in NON_SKILL_STOPWORDS:
                print(f"  ⊗ Filtered stopword: {skill_clean}")
                continue
           
            # ✅ NEW: Filter out multi-word phrases that start with stopwords
