...
import { Eye, User, Mail, Award, Calendar, ArrowLeft, Briefcase } from "lucide-react";
...
const MatchedResume = () => {
  ...
  // --- ADAPTIVE SIDEBAR STATE (default collapsed so pages start narrow like others) ---
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-teal-50 via-white to-blue-50">
      {/* GLOBAL HEADER — keeps page consistent with other pages */}
      <GlobalHeader />


      {/* layout below the fixed header */}
      <div className="flex flex-1 pt-[90px]">
        {/* Pass setCollapsed so sidebar can notify this page about changes */}
        <HiringManagerSidebar collapsed={collapsed} setCollapsed={setCollapsed} />


        {/* Main area shifts according to collapsed state */}
        <main
                                ...
                                <div className="flex items-center gap-2 text-gray-700">
                                  ...
                                  <span>
                                    ...
                                    {resume.candidate_type
                                      ? resume.candidate_type.toString().toLowerCase() === "internal"
                                        ? "Internal"
                                        : "External"
                                      : "Not specified"}
                                  </span>
