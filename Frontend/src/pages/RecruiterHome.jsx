    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#F5F9FC] via-[#ECF3F6] to-[#E6F0F5]">
      ...
      <div className="flex flex-1 pt-[24px]">
        ...
        >
          ...
          <div
            className="absolute inset-0 bg-[url('https://www.toptal.com/designers/subtlepatterns/uploads/dot-grid.png')] opacity-[0.07] pointer-events-none"
            aria-hidden
          />
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="mb-10 md:mb-12 mt-6">
              <h1 className="text-3xl md:text-4xl font-extrabold text-[#0C1C26] flex items-center gap-2">
                Welcome, Recruiter <span className="text-4xl" />
              </h1>
              <p className="text-gray-600 mt-2 text-[14px] md:text-[15px]">
                Manage your entire recruitment workflow — upload, search, analyze,
                and organize resumes effortlessly.
              </p>
            </div>
            ...
            >
              ...
              {/* ⭐ NEW All JDs CARD (Manually Inserted) */}
              <div
